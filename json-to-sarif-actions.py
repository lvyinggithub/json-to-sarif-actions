...
#Only service specific types of data.On runner.Because runner doesn't have a JSON plug-in, it's a simple way
...
sarif_file_content = '{ "$schema": "https://schemastore.azurewebsites.net/schemas/json/sarif-2.1.0-rtm.4.json", "version": "2.1.0", "runs": [ { "tool": { "driver": { "name": "dep-scan", "fullName": "dep-scan-tools", "version": "0.0.0", "semanticVersion": "0.0.0", "dottedQuadFileVersion": "0.0.0.0", "rules": [ { "id":  "dep-scan-'+nowDate+'", "shortDescription": { "text": "dep-san title" }, "fullDescription": { "text": "dep-san full description" }, "help": { "text": "dep-scan-results\\nPackage: Package-string\\nVersion: Version-string\\nLicense Id: License Id string\\nLicense conditions: License conditions string\\n", "markdown": "**dep-scan-results**\\n| '+tiele+ '| \\n| --- | --- | --- | --- | \\n|'+content+'|\\n" } } ] } }, "logicalLocations": [ { "name": "dockerfile", "fullyQualifiedName": "dockerfile", "kind": "namespace" } ], "results": [ { "ruleId": "dep-scan-'+nowDate+'", "ruleIndex": 0, "level": "error", "message": { "text": "temp.sarif", "id": "default'+nowDate+'" }, "analysisTarget": { "uri": "temp.sarif" }, "locations": [ { "physicalLocation": { "artifactLocation": { "uri": "temp.sarif" }, "region": { "startLine": 1, "startColumn": 1, "endLine": 1, "endColumn": 1, "byteOffset": 1, "byteLength": 1 } }, "logicalLocations": [ { "fullyQualifiedName": "dockerfile" } ] } ], "suppressions": [ { "kind": "external" } ], "baselineState": "unchanged" }, { "ruleId":  "dep-scan-'+nowDate+'", "ruleIndex": 0, "level": "error", "message": { "text": "The path temp.sarif ", "id": "default'+nowDate+'" }, "analysisTarget": { "uri": "temp.sarif" }, "locations": [ { "physicalLocation": { "artifactLocation": { "uri": "temp.sarif" }, "region": { "startLine": 1, "startColumn": 1, "endLine": 1, "endColumn": 1, "byteOffset": 1, "byteLength": 1 } }, "logicalLocations": [ { "fullyQualifiedName": "dockerfile" } ] } ], "suppressions": [ { "kind": "external" } ], "baselineState": "unchanged" } ], "columnKind": "utf16CodeUnits" } ] }'
